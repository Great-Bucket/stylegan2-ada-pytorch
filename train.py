...
def setup_training_loop_kwargs(
    ...
    augpipe    = None, # Augmentation pipeline: 'blit', 'geom', 'color', 'filter', 'noise', 'cutout', 'bg', 'bgc' (default), ..., 'bgcfnc', 'bgc_rotate0'
    initstrength = None,
    ...
    cfg_specs = {
        ...
        'custom_a100':   dict(ref_gpus=8,  kimg=25000,  mb=64, mbstd=8,  fmaps=1, lrate=0.002,  gamma=2,    ema=10,  ramp=None, map=8), # added for a100 gpuz
    }   
    ...
    augpipe_specs = {
        ...
        'bgc_rotate0': dict(xflip=1, rotate90=0, xint=1, scale=1, rotate=1, aniso=1, xfrac=1, brightness=1, contrast=1, lumaflip=1, hue=1, saturation=1)
    }
...
# Base config.
@click.option('--cfg', help='Base config [default: auto]', type=click.Choice(['auto', '11gb-gpu','11gb-gpu-complex', '24gb-gpu','24gb-gpu-complex', '48gb-gpu','48gb-2gpu', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'cifarbaseline', 'aydao', 'custom_a100']))
...
@click.option('--augpipe', help='Augmentation pipeline [default: bgc]', type=click.Choice(['blit', 'geom', 'color', 'filter', 'noise', 'cutout', 'bg', 'bgc', 'bgcf', 'bgcfn', 'bgcfnc', 'bgc_rotate0']))
