...
def setup_training_loop_kwargs(
    ...
    augpipe_specs = {
        ...
        'bgc_rotate90_0': dict(xflip=1, rotate90=0, xint=1, scale=1, rotate=1, aniso=1, xfrac=1, brightness=1, contrast=1, lumaflip=1, hue=1, saturation=1),
        'bgc_no_rotate':  dict(xflip=1, rotate90=0, xint=1, scale=1, rotate=0, aniso=1, xfrac=1, brightness=1, contrast=1, lumaflip=1, hue=1, saturation=1)
    }
